...
print(f"{config['Main']}{output_prefix}.config has been created! \nYou can use `bash transcript-toolkit.sh $Function {output_prefix}.config` or `sbatch transcript-toolkit.sh $Function {output_prefix}.config` in your terminal.")
print(f"You can get more information for the Function variable of transcript-toolkit.sh by using bash `transcript-toolkit.sh -h`")
